...
const About = ({ location }) => (
  <div className="site-info-container">
    ...
    <div className="about-container">
      ...
      <p>SolarSurfing is created by me, Daniel Fletcher, as an exercise in React, Redux, and Rails. The project was motivated, at some level, by a desire to go to space; but since I can't do it quite yet I've settled for making this groovy site instead.</p>
